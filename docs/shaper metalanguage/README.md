...
For the full syntax grammar of Shaper metalanguage check "[Shaper Parser Syntax Grammar.pdf](https://github.com/Team-di-Sviluppo-UniSIR/GCode-Shaper-Parser/blob/main/docs/shaper%20metalanguage/Shaper%20Parser%20Syntax%20Grammar.pdf)" file.
